...
const MyCalendar = () => {
  ...
  const events = [
    {
      title: 'My Event',
      start: new Date('2023-03-4'),
      end: new Date('2023-03-10'),
  ...
  const test = (event: Object, start: Date, end: Date, isSelected: boolean): any => {
    // console.log(event)
    // console.log(start)
    // console.log(Date)
  ...
  return (
    <Calendar
      ...
      // selectable={false} // onSelectSlot 할 때 꼭 넣어줘야 함
